...
|===
| SMF 
| `tcps://smf-pubsubplus.apps.your_cluster_domain.com:443`
| SMF over websocket
| `wss://smfweb-pubsubplus.apps.your_cluster_domain.com:443`
| AMQP
| `amqps://amqp-pubsubplus.apps.your_cluster_domain.com:443`
| MQTT
| `ssl://mqtt-pubsubplus.apps.your_cluster_domain.com:443`
| MQTT over websocket
| `wss://mqttweb-pubsubplus.apps.your_cluster_domain.com:443`
|===
